...
/**
 * Represents the chain config for an Patex chain
 */
export interface PatexChainConfig extends ChainConfig {
  patex: {
...
/**
 * Represents the Genesis file format for an Patex chain
 */
export interface PatexGenesis extends Genesis {
