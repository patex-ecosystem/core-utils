# @eth-patex/core-utils

## What is this?

`@eth-patex/core-utils` contains the Patex Virtual Machine core utilities.
...
```typescript
import { TxGasLimit } from '@eth-patex/core-utils'
import { JsonRpcProvider } from 'ethers'

const L2Provider = new JsonRpcProvider('https://mainnet.patex.io')
